...
export default function AdminGuard({ 
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Controleren admin toegang...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-2">Alleen email adressen van de volgende domeinen zijn toegestaan: {getAllowedEmailDomainsClient().join(', ')}</p>
  ...
  if (userRole && userRole !== 'ADMIN') {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-red-600 mb-4">Admin Toegang Vereist</h2>
          <p className="text-gray-600 mb-2">Je hebt geen admin rechten om deze pagina te bekijken.</p>
